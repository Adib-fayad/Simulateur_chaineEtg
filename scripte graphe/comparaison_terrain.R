...
load("data/Volume_etang/Plat.Rdata")
load("data/Volume_etang/Carronnier.Rdata")
load("data/Volume_etang/Corveyzieux.Rdata")
load("data/Volume_etang/Four.Rdata")
load("data/Volume_etang/Ligniere.Rdata")
