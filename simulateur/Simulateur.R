...
cat(paste("\nUCCÈS TOTAL ! Les fichiers", nom_fichier_base, "et", nom_fichier_modif, "sont sauvegardés.\n"))
...
# Nom de fichier distinct
nom_fichier_exp <- paste0("L0.05_Pant10_CN_base_ExpRemonde_", date_heure, ".rds")
saveRDS(resultats_exp_remonde, file = nom_fichier_exp)

cat(paste("\n✅ SUCCÈS TOTAL ! L'expérimentation ciblée a été sauvegardée dans :", nom_fichier_exp, "\n"))